...
with tab1:
    ...
    if st.button("Consultar Pacientes"):
        ...
        if response.status_code == 200:
            ...
            if pacientes:
                # Convertir a DataFrame para tabla bonita
    ...
    if st.button("Cargar Observaciones"):
        ...
        if response.status_code == 200:
            ...
            if observaciones:
                ...
                # Gráfica de líneas con Plotly (Guía E.2)
                ...
                # Mostrar datos en tabla con nombre del paciente
                st.dataframe(
        ...
        if response.status_code == 200:
            ...
            if observaciones:
                ...
                for obs in observaciones:
                    # Validación de outliers (ejemplos clínicos)
                    es_outlier = False
                    razon = ""
                    ...
                    if es_outlier:
                        outliers.append({
                            ...
                            "Nombre del Paciente": obs.get("patient_name", "Desconocido"),  # ✅ Muestra el nombre
                            "Tipo": obs.get("type"),
                            "Valor": obs.get("value"),
                            "Unidad": obs.get("unit"),
                            "Alerta": razon
